...
from madmom.audio.chroma import CLPChroma, DeepChromaProcessor
...
sample_act_deep_chroma = Activations(pj(ACTIVATIONS_PATH, "sample.deep_chroma.npz"))
...
class TestCLPChromaClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.clp_22050 = CLPChroma(sample_file_22050, fps=50, fmin=2637, fmax=4200)
    ...
    def test_process(self):
        ...
        tar = [
            [0.23144638, 0.42642003],
            [0.23364208, 0.49532055],
            [0.2099782, 0.53246478],
            [0.2120323, 0.49525887],
        ]
        ...
        self.assertTrue(np.allclose(self.clp_10_from_signal[2:6, 7:9], tar, atol=1e-4))
    ...
    def test_compare_with_matlab_toolbox(self):
        ...
        tar = np.array(
            [
                [0.22728066, 0.42691203],
                [0.23012684, 0.49625964],
                [0.20832211, 0.53284996],
                [0.21247771, 0.49591485],
            ]
        )
