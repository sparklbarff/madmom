...
class TestEventsClass(unittest.TestCase):
    ...
    def test_equality(self):
        self.assertEqual(self.e1, NoteOnEvent(tick=100, pitch=50, velocity=60))
        self.assertNotEqual(self.e1, NoteOnEvent(tick=101, pitch=50, velocity=60))
        self.assertNotEqual(self.e1, NoteOnEvent(tick=100, pitch=51, velocity=60))
        self.assertNotEqual(self.e1, NoteOnEvent(tick=100, pitch=50, velocity=61))
        self.assertNotEqual(self.e1, NoteOnEvent(tick=100, pitch=50, velocity=60, channel=1))
        self.assertNotEqual(self.e1, NoteOffEvent(tick=100, pitch=50))
