...
class TestKeyLabelToClassFunction(unittest.TestCase):
    ...
    def test_values(self):
        ...
        self.assertEqual(key_label_to_class("C major"), key_label_to_class("C maj"))
        self.assertEqual(key_label_to_class("F minor"), key_label_to_class("F min"))
        self.assertEqual(key_label_to_class("gb maj"), key_label_to_class("F# major"))


class TestErrorTypeFunction(unittest.TestCase):

    def _compare_scores(self, correct, fifth_strict, fifth_lax, relative, parallel):
...
class TestAddParserFunction(unittest.TestCase):
    ...
    def test_args(self):
        args = self.parser.parse_args(["key", ANNOTATIONS_PATH, DETECTIONS_PATH])
