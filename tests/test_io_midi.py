    ...
    def test_sustain(self):
        ...
        self.assertTrue(
            np.allclose(
                midi.notes,
                [
                    [0.146875, 72.0, 3.32291667, 63.0, 0.0],
                    [1.56666667, 41.0, 0.22291667, 29.0, 0.0],
                    [2.525, 77.0, 0.93020833, 72.0, 0.0],
                    [2.54895833, 60.0, 0.21041667, 28.0, 0.0],
                    [2.5625, 65.0, 0.20208333, 34.0, 0.0],
                    [2.57604167, 56.0, 0.234375, 31.0, 0.0],
                    [3.36875, 75.0, 0.78020833, 64.0, 0.0],
                    [3.44895833, 43.0, 0.271875, 35.0, 0.0],
                ],
            )
        )
        self.assertTrue(
            np.allclose(
                midi.sustained_notes,
                [
                    [0.146875, 72.0, 4.00208333, 63.0, 0.0],
                    [1.56666667, 41.0, 0.22291667, 29.0, 0.0],
                    [2.525, 77.0, 1.62395833, 72.0, 0.0],
                    [2.54895833, 60.0, 0.21041667, 28.0, 0.0],
                    [2.5625, 65.0, 0.20208333, 34.0, 0.0],
                    [2.57604167, 56.0, 0.234375, 31.0, 0.0],
                    [3.36875, 75.0, 0.78020833, 64.0, 0.0],
                    [3.44895833, 43.0, 0.7, 35.0, 0.0],
                ],
            )
        )
...
class TestLoadMidiFunction(unittest.TestCase):
    ...
    def test_load_midi_sustained(self):
        ...
        notes = load_midi(pj(ANNOTATIONS_PATH, "stereo_sample_sustained.mid"), sustain=True)
